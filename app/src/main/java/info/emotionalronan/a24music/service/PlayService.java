package info.emotionalronan.a24music.service;
...
import info.emotionalronan.a24music.application.Notifier;
import info.emotionalronan.a24music.constants.Actions;
import info.emotionalronan.a24music.enums.PlayModeEnum;
import info.emotionalronan.a24music.model.Music;
import info.emotionalronan.a24music.receiver.NoisyAudioStreamReceiver;
import info.emotionalronan.a24music.utils.MusicUtils;
...
public class PlayService extends Service implements MediaPlayer.OnCompletionListener, AudioManager.OnAudioFocusChangeListener {
    ...
    private List<Music> mPlayingMusicList;
    ...
    public List<Music> getmPlayingMusicList() {
        return mPlayingMusicList;
    }

    public void setmPlayingMusicList(List<Music> mPlayingMusicList) {
        this.mPlayingMusicList = mPlayingMusicList;
    }
    ...
    public void onCreate() {
        ...
        mPlayingMusicList = AppCache.getPlayingMusicList();
    ...
    public void updateMusicList() {
        //扫描本地音乐放在mMusicList 中
        MusicUtils.scanMusic(this, mMusicList);

        MusicUtils.scanMusic(this, mPlayingMusicList);
