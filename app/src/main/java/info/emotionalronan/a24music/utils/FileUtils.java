package info.emotionalronan.a24music.utils;
...
public class FileUtils {
    ...
    private static String getAppDir() {
        return Environment.getExternalStorageDirectory().getPath() + "/A24Music";
//        return Environment.getExternalStorageDirectory() + "/A24Music";
    }

    public static String getMusicDir() {
//        String dir =  Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MUSIC)+ "/A24Music/";
